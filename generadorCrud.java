...
public class generadorCrud {
    public static void main(String[] args) throws IOException {
        ...
        TipoEstructura tipoEstructuraGenerador = new TipoEstructura();

        String directorioControlador = tipoEstructuraGenerador.controlador(nombreEntidad, tipoEstructura, nombreDeAplicacion);
        String directorioEntidad = tipoEstructuraGenerador.entidad(nombreEntidad, tipoEstructura);
        String directorioRepositorio = tipoEstructuraGenerador.repositorio(nombreEntidad, tipoEstructura);
        String directorioServicio = tipoEstructuraGenerador.servicio(nombreEntidad, tipoEstructura);
        String directorioServicioImplementacion = tipoEstructuraGenerador.servicioImpl(nombreEntidad, tipoEstructura);
